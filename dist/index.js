...
const micromarkExtensionGfm = require("micromark-extension-gfm");
const mdastUtilGfm = require("mdast-util-gfm");
...
const mdastUtilMdxJsx = require("mdast-util-mdx-jsx");
const mdastUtilFromMarkdown = require("mdast-util-from-markdown");
const flatten = require("lodash.flatten");
const estreeUtilIsIdentifierName = require("estree-util-is-identifier-name");
const micromarkFactoryMdxExpression = require("micromark-factory-mdx-expression");
const micromarkFactorySpace = require("micromark-factory-space");
const micromarkUtilCharacter = require("micromark-util-character");
const acorn = require("acorn");
const mdastUtilCompact = require("mdast-util-compact");
const unistUtilVisit = require("unist-util-visit");
require("micromark-factory-whitespace");
const unistUtilSource = require("unist-util-source");
...
exports.stringifyMDX = stringifyMDX$1;
