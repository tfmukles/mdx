(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("remark"), require("remark-mdx"), require("micromark-extension-gfm"), require("mdast-util-gfm"), require("remark-gfm"), require("mdast-util-to-markdown"), require("ccount"), require("parse-entities"), require("unist-util-stringify-position"), require("vfile-message"), require("stringify-entities"), require("mdast-util-mdx-jsx"), require("mdast-util-from-markdown"), require("lodash.flatten"), require("estree-util-is-identifier-name"), require("micromark-factory-mdx-expression"), require("micromark-factory-space"), require("micromark-util-character"), require("acorn"), require("mdast-util-compact"), require("unist-util-visit"), require("micromark-factory-whitespace"), require("unist-util-source")) : typeof define === "function" && define.amd ? define(["exports", "remark", "remark-mdx", "micromark-extension-gfm", "mdast-util-gfm", "remark-gfm", "mdast-util-to-markdown", "ccount", "parse-entities", "unist-util-stringify-position", "vfile-message", "stringify-entities", "mdast-util-mdx-jsx", "mdast-util-from-markdown", "lodash.flatten", "estree-util-is-identifier-name", "micromark-factory-mdx-expression", "micromark-factory-space", "micromark-util-character", "acorn", "mdast-util-compact", "unist-util-visit", "micromark-factory-whitespace", "unist-util-source"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2["sitepins-mdx-2"] = {}, global2.remark, global2.remarkMdx, global2.micromarkExtensionGfm, global2.mdastUtilGfm, global2.remarkGfm, global2.mdastUtilToMarkdown, global2.ccount, global2.parseEntities, global2.unistUtilStringifyPosition, global2.vfileMessage, global2.stringifyEntities, global2.mdastUtilMdxJsx, global2.mdastUtilFromMarkdown, global2.flatten, global2.estreeUtilIsIdentifierName, global2.micromarkFactoryMdxExpression, global2.micromarkFactorySpace, global2.micromarkUtilCharacter, global2.acorn, global2.mdastUtilCompact, global2.unistUtilVisit, null, global2.unistUtilSource));
})(void 0, function(exports2, remark, remarkMdx, micromarkExtensionGfm, mdastUtilGfm, remarkGfm, mdastUtilToMarkdown, ccount, parseEntities, unistUtilStringifyPosition, vfileMessage, stringifyEntities, mdastUtilMdxJsx, mdastUtilFromMarkdown, flatten, estreeUtilIsIdentifierName, micromarkFactoryMdxExpression, micromarkFactorySpace, micromarkUtilCharacter, acorn, mdastUtilCompact, unistUtilVisit, micromarkFactoryWhitespace, unistUtilSource) {
...
var __publicField = (obj, key, value) => {
  ...
  function mdxJsxFromMarkdown({ patterns }) {
    ...
    const enterMdxJsxTagSelfClosingMarker = function(token) {
      ...
      if (tag == null ? void 0 : tag.close) {
        throw new vfileMessage.VFileMessage(
    ...
    const exitMdxJsxTagAttributeValueLiteral = function() {
      ...
      if (tag) {
        ...
        if (attribute) {
          ...
          attribute.value = parseEntities.parseEntities(this.resume(), {
            nonTerminated: false
          });
        }
      }
    ...
    const exitMdxJsxTag = function(token) {
      ...
      if (tail && tag.close && tail.name !== tag.name) {
        throw new vfileMessage.VFileMessage(
          "Unexpected closing tag `" + serializeAbbreviatedTag(tag) + "`, expected corresponding closing tag for `" + serializeAbbreviatedTag(tail) + "` (" + unistUtilStringifyPosition.stringifyPosition(tail) + ")",
          { start: token.start, end: token.end },
        ...
        while (++index < node.attributes.length) {
          ...
          if ((attribute == null ? void 0 : attribute.type) === "mdxJsxExpressionAttribute") {
            ...
            if (value2 === void 0 || value2 === null)
              ...
              const appliedQuote = quoteSmart && ccount.ccount(value2, quote) > ccount.ccount(value2, alternative) ? alternative : quote;
              right = appliedQuote + stringifyEntities.stringifyEntitiesLight(value2, { subset: [appliedQuote] }) + appliedQuote;
            }
            if (left === "_value") {
              result = right;
            } else {
  ...
  const toTinaMarkdown$1 = (tree, field) => {
    ...
    return mdastUtilToMarkdown.toMarkdown(tree, {
      extensions: [mdxJsxToMarkdown({ patterns }), mdastUtilGfm.gfmToMarkdown()],
      listItemIndent: "one",
      handlers
    });
  };
...
${val}
  ...
  function attributes(node, state) {
    ...
    function quoted(key2, value) {
      const v = quote + stringifyEntities.stringifyEntitiesLight(value, { subset }) + quote;
      if (key2 === "_value") {
        return v;
      }
      return key2 + (value ? "=" + v : "");
  ...
  const toTinaMarkdown = (tree, field) => {
    ...
    return mdastUtilToMarkdown.toMarkdown(tree, {
      extensions: [
        ...
        mdastUtilMdxJsx.mdxJsxToMarkdown(),
        mdastUtilGfm.gfmToMarkdown()
      ],
      listItemIndent: "one",
      handlers
    });
...
${val}
  ...
  function factoryTag(effects, ok$1, nok, acorn2, acornOptions, addResult, allowLazy, tagType, tagMarkerType, tagClosingMarkerType, tagSelfClosingMarker, tagNameType, tagNamePrimaryType, tagNameMemberMarkerType, tagNameMemberType, tagNamePrefixMarkerType, tagNameLocalType, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, tagAttributeType, tagAttributeNameType, tagAttributeNamePrimaryType, tagAttributeNamePrefixMarkerType, tagAttributeNameLocalType, tagAttributeInitializerMarkerType, tagAttributeValueLiteralType, tagAttributeValueLiteralMarkerType, tagAttributeValueLiteralValueType, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionValueType, pattern) {
    ...
    const beforeName = function(code) {
      ...
      if (code !== codes.eof && estreeUtilIsIdentifierName.start(code) && findCode(pattern.name[0]) === code) {
    ...
    const beforeClosingTagName = function(code) {
      ...
      if (code !== codes.eof && estreeUtilIsIdentifierName.start(code)) {
        effects.enter(tagNameType);
        effects.enter(tagNamePrimaryType);
        effects.consume(code);
        return primaryName;
    ...
    const primaryName = function(code) {
      ...
      nameIndex = 0;
      if (code === codes.dot || code === codes.slash || code === codes.colon || code === codes.greaterThan || code === findCode(pattern.end[0]) || micromarkUtilCharacter.markdownLineEndingOrSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code)) {
    ...
    const afterPrimaryName = function(code) {
      ...
      if (code === codes.slash || code === codes.greaterThan || code === codes.leftCurlyBrace || code !== codes.eof && estreeUtilIsIdentifierName.start(code)) {
        effects.exit(tagNameType);
        return beforeAttribute(code);
      }
    ...
    const memberName = function(code) {
      if (code === codes.dash || code !== codes.eof && estreeUtilIsIdentifierName.cont(code)) {
        effects.consume(code);
        return memberName;
      }
      if (code === codes.dot || code === codes.slash || code === codes.greaterThan || code === codes.leftCurlyBrace || micromarkUtilCharacter.markdownLineEndingOrSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code)) {
    ...
    const localName = function(code) {
      ...
      if (code === codes.slash || code === codes.greaterThan || code === codes.leftCurlyBrace || micromarkUtilCharacter.markdownLineEndingOrSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code)) {
    ...
    const beforeAttribute = function(code) {
      ...
      if (code === codes.leftCurlyBrace) {
        ...
        return micromarkFactoryMdxExpression.factoryMdxExpression.call(
          self2,
          effects,
    ...
    const attributePrimaryName = function(code) {
      ...
      if (code === codes.slash || code === codes.colon || code === codes.equalsTo || code === codes.greaterThan || code === codes.leftCurlyBrace || micromarkUtilCharacter.markdownLineEndingOrSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code)) {
        effects.exit(tagAttributeNamePrimaryType);
    ...
    const afterAttributePrimaryName = function(code) {
      ...
      if (code === codes.slash || code === codes.greaterThan || code === codes.leftCurlyBrace || micromarkUtilCharacter.markdownLineEndingOrSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code) || code !== codes.eof && estreeUtilIsIdentifierName.start(code)) {
        effects.exit(tagAttributeNameType);
    ...
    const attributeLocalName = function(code) {
      ...
      if (code === codes.slash || code === codes.equalsTo || code === codes.greaterThan || code === codes.leftCurlyBrace || micromarkUtilCharacter.markdownLineEndingOrSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code)) {
    ...
    const attributeValueQuoted = function(code) {
      if (code === codes.eof || code === marker || micromarkUtilCharacter.markdownLineEnding(code)) {
    ...
    const optionalEsWhitespace = function(code) {
      if (micromarkUtilCharacter.markdownLineEnding(code)) {
        if (allowLazy) {
          ...
          return micromarkFactorySpace.factorySpace(
            effects,
        ...
        return effects.attempt(
          lazyLineEnd,
          micromarkFactorySpace.factorySpace(
            effects,
            optionalEsWhitespace,
            types.linePrefix,
            constants.tabSize
      ...
      if (micromarkUtilCharacter.markdownSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code)) {
    ...
    const optionalEsWhitespaceContinue = function(code) {
      if (micromarkUtilCharacter.markdownLineEnding(code) || !(micromarkUtilCharacter.markdownSpace(code) || micromarkUtilCharacter.unicodeWhitespace(code))) {
  ...
  const tokenizeLazyLineEnd = function(effects, ok$1, nok) {
    const self2 = this;
    const start = function(code) {
      ok(micromarkUtilCharacter.markdownLineEnding(code), "expected eol");
      effects.enter(types.lineEnding);
      effects.consume(code);
      effects.exit(types.lineEnding);
      return lineStart;
    ...
    const tokenizeJsxFlow = function(effects, ok2, nok) {
      ...
      const start = function(code) {
        return factoryTag.call(
          self2,
          effects,
          micromarkFactorySpace.factorySpace(effects, after, types.whitespace),
          nok,
          acorn2,
          acornOptions,
          addResult,
      ...
      const after = function(code) {
        ...
        if (micromarkUtilCharacter.markdownLineEndingOrSpace(code)) {
          return ok2(code);
        }
        return nok(code);
      };
  ...
  const fromMarkdown = (value, field) => {
    const patterns = getFieldPatterns(field);
    const acornDefault = acorn__namespace;
    const skipHTML = false;
    const tree = mdastUtilFromMarkdown.fromMarkdown(value, {
      extensions: [
        micromarkExtensionGfm.gfm(),
        mdxJsx({ acorn: acornDefault, patterns, addResult: true, skipHTML })
      ],
      mdastExtensions: [mdastUtilGfm.gfmFromMarkdown(), mdxJsxFromMarkdown({ patterns })]
    });
    return tree;
  };
  ...
  const directiveElement = (node, field, imageCallback, raw) => {
    ...
    if (!template) {
      return {
        type: "p",
        children: [{ type: "text", text: unistUtilSource.source(node, raw || "") || "" }]
      };
    }
    if (typeof template === "string") {
      throw new Error(`Global templates not supported`);
  ...
  const postProcessor = (tree, field, imageCallback) => {
    ...
    unistUtilVisit.visit(tree, "mdxJsxFlowElement", addPropsToMdxFlow);
    unistUtilVisit.visit(tree, "mdxJsxTextElement", addPropsToMdxFlow);
  ...
  const postProcess = (tree, field, imageCallback) => {
    return postProcessor(mdastUtilCompact.compact(tree), field, imageCallback);
  };
  ...
  const mdxToAst = (value) => {
    return remark.remark().use(remarkMdx).use(remarkGfm).parse(value);
  };
  ...
  exports2.parseMDX = parseMDX;
  exports2.stringifyMDX = stringifyMDX$1;
